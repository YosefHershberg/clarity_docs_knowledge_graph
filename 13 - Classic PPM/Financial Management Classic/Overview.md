...
Enterprise program management offices and financial managers use Classic PPM's financial management capabilities to manage long-term forecasts, short-term cost plans and budgets, and interface with legacy ERP systems and financial tools. Financial management capabilities span the entire lifecycle of a project, application, and service.
...
- Defining a process to set the partition of a cost plan is not necessary — cost plans inherit the partition of the investment

## Standardizing Financial Processing Rules

Navigate to **Administration > Finance > Processing** and configure:

- **Allow Chargeable Override** — Whether resources can change the chargeable status of a cost code during transaction entry
- **Use Multi-Currency** — Enables tracking of multiple currency codes and foreign exchange rates. **Cannot be reverted once enabled**
- **Apply Currency Precision for rate/cost** — Whether currency precision is applied to rate or cost before calculations
- **Entity Based Security** — Security type for financial processing:
  - *None* — No security
  - *Strict* — Access allowed only to specified financial entity objects and transactions
  - *Parent* — Access allowed to specified entity, its parent, and children
- **Hide Financial OBS** — Hides Department and Location OBS types from OBS browse lists

## Related Notes

- [[Financial Summaries]] — High-level planned/budget metrics
- [[Detailed Financial Plans]] — Cost plans, benefit plans, budget plans
- [[Cost Plus Codes]] — Mark-up rules
- [[Financial Processing Setup]] — Enable investments, resources, roles
- [[Financial Departments]] — Set up departments
- [[Financial Locations]] — Set up locations
- [[_MOC Classic PPM]]
