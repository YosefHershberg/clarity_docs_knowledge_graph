---
title: DWH_TRD_META_COLUMNS
type: db-table
table: DWH_TRD_META_COLUMNS
columns: 22
audience: dev
domain: development
canonical: true
...
> [!info] Description
> Trending meta data table that stores column information for the columns being trended out of the box.
...
| `SRC_ALIAS` | NVARCHAR | NULL | Table alias used for the source table. |
