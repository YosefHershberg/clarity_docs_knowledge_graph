---
title: PFM_WEIGHTING_ATTRS
type: db-table
table: PFM_WEIGHTING_ATTRS
columns: 11
audience: dev
domain: development
canonical: true
...
> [!info] Description
> This table contains numeric weights for
...
| --- | --- | --- | --- |
| `ID` | NUMERIC | NOT NULL | This column refers to the ID of the portfolio context. |
| `PORTFOLIO_ID` | NUMERIC | NOT NULL | This column refers to the ID of the plan context. |
| `PLAN_ID` | NUMERIC | NULL | This column refers to the ID of the plan context. |
| `PARENT_ID` | NUMERIC | NULL | The column refers to the ID of a row in this table that is a parent of this row. A typical use is for further breakdown of weightings for an attribute that is a lookup. |
| `ATTRIBUTE` | NVARCHAR | NOT NULL | This column refers to the Attribute to which the weighting applies. |
| `CRITERIA` | NVARCHAR | NULL | This column describes how to apply the criteria. |
| `WEIGHT` | FLOAT | NULL | This column refers to the numeric weighting value. |
