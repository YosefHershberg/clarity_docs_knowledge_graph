---
title: PFM_APPLICATIONS_PLAN
type: db-table
table: PFM_APPLICATIONS_PLAN
columns: 15
audience: dev
domain: development
canonical: true
...
# PFM_APPLICATIONS_PLAN

> [!info] Description
> This table contains Contains scenario data for applications in the context of a portfolio plan
...
| `VERSION` | NVARCHAR | NULL | This column contains changes made to investments in the context of a plan. |
...
| `SUPPLIER` | NVARCHAR | NULL | This column contains changes made to investments in the context of a plan. |
| `POPULATION_SERVED` | NUMERIC | NULL | This column contains changes made to investments in the context of a plan. |
| `LICENSE_COUNT` | NUMERIC | NULL | This column contains changes made to investments in the context of a plan. |
| `FUNCTION_POINTS` | NUMERIC | NULL | This column contains changes made to investments in the context of a plan. |
| `TECHNOLOGY` | NUMERIC | NULL | This column contains changes made to investments in the context of a plan. |
| `PLATFORM` | NUMERIC | NULL | This column contains changes made to investments in the context of a plan. |
