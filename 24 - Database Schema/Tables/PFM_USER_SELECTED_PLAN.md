---
title: PFM_USER_SELECTED_PLAN
type: db-table
table: PFM_USER_SELECTED_PLAN
columns: 3
audience: dev
domain: development
canonical: true
...
# PFM_USER_SELECTED_PLAN

> [!info] Description
> This table contains the selected plan for a portfolio user.
