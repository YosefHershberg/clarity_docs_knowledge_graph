---
title: PFM_SERVICES_PLAN
type: db-table
table: PFM_SERVICES_PLAN
columns: 7
audience: dev
domain: development
canonical: true
...
> [!info] Description
> This table contains changes to service investments in the context of a portfolio.
...
| --- | --- | --- | --- |
| `ID` | NUMERIC | NOT NULL | This column refers to the ID of the investment in the portfolio. |
| `PLAN_ID` | NUMERIC | NOT NULL | This column refers to the ID of the plan context. |
| `APPLICATION_ID` | NUMERIC | NULL | This column contains changes to APPLICATION_ID in the context of a plan. |
