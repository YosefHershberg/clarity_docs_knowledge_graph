---
title: PAC_MNT_PROJECTS
type: db-table
table: PAC_MNT_PROJECTS
columns: 129
audience: dev
domain: development
canonical: true
...
> [!info] Description
> This satellite project table is used for financial processing.
...
| `COST_TYPE` | NVARCHAR | NULL | This column specifies the cost type of investment. |
...
| --- | --- | --- |
| [[BILLINGSCHEDULE]] | `MASTER_PROJECT_CODE` | `PROJECT_CODE` |
| [[OLB_BILLINGCHECKOUT]] | `PROJECT_CODE` | `PROJECT_CODE` |
| [[PAC_BB_SELECTBILL_CONSINV]] | `PROJECT_CODE` | `PROJECT_CODE` |
| [[PAC_BIL_DETAIL_SUMMARY]] | `PROJECT_CODE` | `PROJECT_CODE` |
| [[PAC_BIL_DETAIL_SUMMARY]] | `TITLE` | `TITLE` |
| [[PAC_FRC_FORECAST_PROPERTIES]] | `PROJECT_ID` | `ID` |
| [[PFM_MNT_PROJECTS]] | `BILLING_PROJECT_ID` | `ID` |
| [[PPA_BILLINGS]] | `PROJECT_CODE` | `PROJECT_CODE` |
| [[PPA_TRANSBILL]] | `PROJECT_CODE` | `PROJECT_CODE` |

## Related tables (same subject area)

[[APMASTER]], [[BIZ_COM_PERIODS]], [[BIZ_COM_SUP_PROPERTIES]], [[BIZ_OPP_GEN_PROPERTIES]], [[CBK_ERRORS]], [[CBK_ERROR_ARGUMENTS]], [[CBK_GL_ACCOUNT]], [[CBK_GL_ALLOCATION]], [[CBK_GL_ALLOCATION_DETAIL]], [[CBK_GL_TXNS]], [[CBK_GL_TXN_VALUES]], [[CBK_INVOICE]], [[CBK_SCALED_GL_TXNS]], [[CLNTCLASS]], [[CLNTRESPONS]], [[CLNTSUPP]], [[DEPARTMENTS]], [[DPT_KEYMETRICS]], [[DPT_SUBSCRIPTIONS]], [[ENTITY]], [[FIN_FINANCIALS]], [[INV_APPLICATIONS]], [[INV_ASSETS]], [[INV_HIERARCHIES]], [[INV_INVESTMENTS]], [[INV_OTHERS]], [[INV_PRODUCTS]], [[INV_PROJECTS]], [[INV_SERVICES]], [[LOCATIONDEPT]], [[LOCATIONS]], [[NAMEOPTIONS]], [[ODF_OBJECT_INSTANCE_MAPPINGS]], [[PAC_BATCH_OUTPUT]], [[PAC_CHG_BATCH_HEADERS]], [[PAC_CHG_TRANSACTIONS]], [[PAC_FOS_RESOURCE_CLASS]], [[PAC_FRC_FORECAST_DETAILS]], [[PAC_FRC_FORECAST_PROPERTIES]], [[PAC_MNT_RESOURCES]], [[PAC_PURGE_FINANCIAL_LIST]], [[PPA_BILLINGS]], [[PPA_WIP]], [[PRASSIGNMENT]], [[PRCHARGECODE]], [[PRCONSTRAINT]], [[PRDEPENDENCY]], [[PRJ_BASELINES]], [[PRJ_BASELINE_DETAILS]], [[PRJ_EV_HISTORY]], [[PRJ_OBS_TYPES]], [[PRJ_OBS_UNITS]], [[PRJ_PROJECT_DEPENDS]], [[PRJ_TASK_FORMULAS]], [[PROJCLASS]], [[PROJCNTRTS]], [[PROJREVISION]], [[PROJSTAFF]], [[PRSUBPROJECT]], [[PRTASK]], [[PRTEAM]], [[PRTYPECODE]], [[SRM_COMPANIES]], [[SRM_CONTACTS]], [[SRM_PROJECTS]], [[TRANSCLASS]], [[UNITMEASURE]], [[WIPCLASS]]
