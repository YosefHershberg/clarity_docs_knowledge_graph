---
title: PAC_CHG_RESCREDIT_DETAILS
type: db-table
table: PAC_CHG_RESCREDIT_DETAILS
columns: 8
audience: dev
domain: development
canonical: true
...
| `RES_CREDIT_DATES_ID` | NUMERIC | NULL | This refers to PAC_CHG_RESCREDIT_DATES. ID. |
| `ACCOUNT_CODE_ID` | NUMERIC | NOT NULL | This refers to [[PAC_CHG_GL_ACCOUNTS]].ID. |
| `ALLOCATION_PERCENT` | NUMERIC | NOT NULL | The allocation percentage. |
