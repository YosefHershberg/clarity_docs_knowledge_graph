---
title: DWH_TRD_META_ODF_TABLES
type: db-table
table: DWH_TRD_META_ODF_TABLES
columns: 10
audience: dev
domain: development
canonical: true
...
> [!info] Description
> Trending meta data table that stores header information for the tables being trended that are customer specific.
