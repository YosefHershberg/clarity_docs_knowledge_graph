---
title: PFM_PINNED_INVESTMENTS
type: db-table
table: PFM_PINNED_INVESTMENTS
columns: 7
audience: dev
domain: development
canonical: true
...
# PFM_PINNED_INVESTMENTS

> [!info] Description
> This table contains investments that are to be added to a portfolio.
...
| `PORTFOLIO_ID` | NUMERIC | NOT NULL | This column refers to the Id of the portfolio to add the investment. |
| `INVESTMENT_ID` | NUMERIC | NOT NULL | This column refers to the Id of the investment to add to the portfolio. |
| `CREATED_DATE` | DATE | NOT NULL | This column contains the date that the row was created. |
