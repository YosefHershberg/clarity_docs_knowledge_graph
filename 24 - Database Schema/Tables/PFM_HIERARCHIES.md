---
title: PFM_HIERARCHIES
type: db-table
table: PFM_HIERARCHIES
columns: 8
audience: dev
domain: development
canonical: true
...
> [!info] Description
> This table is used to capture portfolio hierarchies.
...
| `PARENT_ID` | NUMERIC | NULL | This column specifies the Id of the parent portfolio. |
| `CHILD_ID` | NUMERIC | NOT NULL | This column specifies the Id of the child portfolio. |
| `DEFAULT_ALLOC_PCT` | NUMERIC | NULL | This column contains the allocation percentage of the child portfolio that should be aggregated to the parent. |
