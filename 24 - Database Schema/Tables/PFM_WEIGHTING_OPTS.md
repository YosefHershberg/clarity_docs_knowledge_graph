---
title: PFM_WEIGHTING_OPTS
type: db-table
table: PFM_WEIGHTING_OPTS
columns: 9
audience: dev
domain: development
canonical: true
...
> [!info] Description
> This table contains weighting options.
...
| `WL_INC_DEP_INVS` | INTEGER | NOT NULL | Indicator that dependent investments should be included. |
| `PRIMARY_CONSTRAINT` | NVARCHAR | NULL | This column refers to the Primary constraint attribute. |
| `CREATED_DATE` | DATE | NOT NULL | This column contains the date the row was last created. |
