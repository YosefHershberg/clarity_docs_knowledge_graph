---
title: INV_APPLICATIONS
type: db-table
table: INV_APPLICATIONS
columns: 14
audience: dev
domain: development
canonical: true
...
| `POPULATION_SERVED` | NUMERIC | NOT NULL | The number of users of the application. |
| `LICENSE_COUNT` | NUMERIC | NOT NULL | The number of licenses for the application. |
| `FUNCTION_POINTS` | NUMERIC | NOT NULL | The number of function points in the application. |
...
| --- | --- | --- |
| [[INV_SERVICES]] | `APPLICATION_ID` | `ID` |
| [[PFM_SERVICES]] | `APPLICATION_ID` | `ID` |
