---
title: PFM_CONTENT_FILTERS
type: db-table
table: PFM_CONTENT_FILTERS
columns: 9
audience: dev
domain: development
canonical: true
...
> [!info] Description
> This table contains power filter expressions that define the contents of a portfolio.
...
| --- | --- | --- | --- |
| `ID` | NUMERIC | NOT NULL | Specifies the primary Id of the row in the table |
| `OBJECT_TYPE_CODE` | NVARCHAR | NOT NULL | This column refers to the Object code for the investment type. |
| `IS_INCLUDED` | NUMERIC | NULL | Includes the expression in the portfolio. |
| `PORTFOLIO_ID` | NUMERIC | NOT NULL | Specifies the Key to the portfolio. |
| `FILTER_ID` | NUMERIC | NULL |  |
