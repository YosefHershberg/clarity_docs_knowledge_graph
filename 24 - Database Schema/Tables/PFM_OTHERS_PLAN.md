---
title: PFM_OTHERS_PLAN
type: db-table
table: PFM_OTHERS_PLAN
columns: 7
audience: dev
domain: development
canonical: true
...
> [!info] Description
> This table contains plan data for Other Work investments in the context of a plan.
...
| --- | --- | --- | --- |
| `ID` | NUMERIC | NOT NULL | This column refers to the Id of the portfolio investment. |
