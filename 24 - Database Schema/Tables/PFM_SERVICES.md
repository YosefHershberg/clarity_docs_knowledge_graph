...
> [!info] Description
> This table contains copy of service investments in the context of portfolio.
...
| --- | --- | --- | --- |
| `ID` | NUMERIC | NOT NULL | This column specifies the primary key of the row in the table. |
