---
title: PFM_PRODUCTS_PLAN
type: db-table
table: PFM_PRODUCTS_PLAN
columns: 9
audience: dev
domain: development
canonical: true
...
> [!info] Description
> This tables contains the changes to the product in the context of a plan.
...
| --- | --- | --- | --- |
| `ID` | NUMERIC | NOT NULL | The column refers to the PK of the product row. |
| `PLAN_ID` | NUMERIC | NOT NULL | This column refers to the ID of the plan context. |
| `VERSION` | NVARCHAR | NULL | This column contains changes to VERSION in the context of a plan. |
| `TCO` | NUMERIC | NULL | This column contains changes to TCO in the context of a plan. |
| `CATEGORY_CODE` | NVARCHAR | NULL | This column contains changes to CATEGORY_CODE in the context of a plan. |
